  ...
  return (
    <ScreenContainer>
      <View className="flex-1 justify-center gap-4">
        <Text className="text-3xl font-bold text-text">Inscription</Text>
        ...
        <Button label={loading ? "Chargement..." : "Creer mon compte"} onPress={handleSubmit(onSubmit)} disabled={loading} />
        <Link href="/(auth)/login" asChild><Text className="text-center text-primary">Deja un compte ?</Text></Link>
      </View>
    </ScreenContainer>
  );
}
